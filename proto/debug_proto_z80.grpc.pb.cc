...
#include "debug_proto_z80.grpc.pb.h"
...
static const char* DbgServer_method_names[] = {
  ...
  "/idadebug.DbgServer/get_sound_banks",
};
...
::grpc::Status DbgServer::Stub::get_sound_banks(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::idadebug::SoundBankMap* response) {
...
::grpc::ClientAsyncResponseReader< ::idadebug::SoundBankMap>* DbgServer::Stub::PrepareAsyncget_sound_banksRaw(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::idadebug::SoundBankMap, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_get_sound_banks_, context, request);
}

::grpc::ClientAsyncResponseReader< ::idadebug::SoundBankMap>* DbgServer::Stub::Asyncget_sound_banksRaw(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncget_sound_banksRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
DbgServer::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DbgServer::Service, ::google::protobuf::Empty, ::idadebug::SoundBankMap, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](DbgServer::Service* service,
             ::grpc::ServerContext* ctx,
             const ::google::protobuf::Empty* req,
             ::idadebug::SoundBankMap* resp) {
               return service->get_sound_banks(ctx, req, resp);
             }, this)));
}
...
::grpc::Status DbgServer::Service::get_sound_banks(::grpc::ServerContext* context, const ::google::protobuf::Empty* request, ::idadebug::SoundBankMap* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
